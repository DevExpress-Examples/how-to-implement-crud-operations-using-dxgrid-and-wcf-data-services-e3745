...
' Original file name:
' Generation date: 11.01.2012 12:27:14

Imports Microsoft.VisualBasic
Imports System
Namespace WCFInstantFeedbackCRUD.NorthwindService
	...
	Partial Public Class NorthwindEntities
		...
		Protected Function ResolveTypeFromName(ByVal typeName As String) As Global.System.Type
			If typeName.StartsWith("NorthwindModel", Global.System.StringComparison.Ordinal) Then
				Return Me.GetType().Assembly.GetType(String.Concat("WCFInstantFeedbackCRUD.NorthwindService", typeName.Substring(14)), False)
			End If
			Return Nothing
		End Function
		''' <summary>
		...
		Protected Function ResolveNameFromType(ByVal clientType As Global.System.Type) As String
			If clientType.Namespace.Equals("WCFInstantFeedbackCRUD.NorthwindService", Global.System.StringComparison.Ordinal) Then
